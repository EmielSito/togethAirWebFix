...
insert into seat(id, seatNumber, basePrice, classType, isAvailable, plane_id) values(2000, '1d', 1200, 'BUSINESS',true, 1000);
insert into seat(id, seatNumber, basePrice, classType, isAvailable, plane_id) values(4000, '1a', 800, 'ECONOMIC',true,  2000);
insert into seat(id, seatNumber, basePrice, classType, isAvailable, plane_id) values(5000, '2b', 800, 'ECONOMIC',true,  2000);
